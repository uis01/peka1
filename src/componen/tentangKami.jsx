        ...
        <>
            <div className="containerRoot flex flex-row h-full">
                ...
                <div className="containerIsi p-4 sm:pl-32 w-full mt-0 sm:mt-10 mb-32 mx-auto sm:ml-52 sm:mr-0 ">
                    ...
                    {/* content  */}
                    <div className="containerContent  absolute top-40 ml-5 mb-40">
                        ...
                        <div className='w-full flex flex-row'>
                            <p className='w-1/2  font-semibold'>"Anak-anak adalah investasi terbaik untuk masa depan kita. Berikan mereka makanan dan layanan kesehatan yang baik, dan Anda memberi mereka modal untuk sukses sepanjang hidup mereka."</p>
                            <br />
