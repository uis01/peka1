        ...
        <>
            <div className="containerRoot  h-full bg-white ">
                ...
                <div className="containerIsi p-4 sm:pl-32 mt-0 sm:mt-10 mb-20 mx-auto sm:ml-52 sm:mr-0 ">
                    ...
                    {/* content  Start*/}
                    <div className=' sm:mt-20 mt-10 mx-auto'>
                        <select name="filter" id="#" className='bg-blue-900 text-white px-3 py-1 rounded-full mr-40 float-right mb-5'>
                            <option value="">Filter by</option>
                            <option value="">A-Z</option>
                            <option value="">Z-A</option>
                        </select>

                        <table className='w-5/6 text-center table-auto border-collapse border border-slate-400 mt-2 px-4 py-4'>
                            <tr>
                                <th className='border border-slate-300 px-3 py-4'>No</th>
                                <th className='border border-slate-300 px-3 py-4'>Tanggal Cek</th>
                                <th className='border border-slate-300 px-3 py-4'>Berat Badan</th>
                                <th className='border border-slate-300 px-3 py-4'>Tinggi Badan</th>
                                <th className='border border-slate-300 px-3 py-4'>Rek.Nutrisi</th>
                                <th className='border border-slate-300 px-3 py-4'>Deskripsi</th>

                            </tr>
                            <tr>
                                <td className='border border-slate-300 px-1 py-4'>1</td>
                                <td className='border border-slate-300 px-1 py-4'>02 Mei 2024</td>
                                <td className='border border-slate-300 px-1 py-4'>5 kg</td>
                                <td className='border border-slate-300 px-1 py-4'>78,6 cm</td>
                                <td className='border border-slate-300 px-1 py-4'>telur, produk susu, dan kacang-kacangan.</td>
                                <td className='border border-slate-300 px-1 py-4'>Normal dan sehat</td>
                            </tr>
                            <tr>
